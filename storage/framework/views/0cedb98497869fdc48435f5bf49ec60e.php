<div class="max-w-4xl mx-auto">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        <div class="bg-surface border border-border rounded-xl p-4 text-center">
            <p class="text-3xl font-bold text-primary"><?php echo e($stats['total_queues']); ?></p>
            <p class="text-sm text-text-secondary mt-1">Total Antrian</p>
        </div>
        <div class="bg-surface border border-border rounded-xl p-4 text-center">
            <p class="text-3xl font-bold text-warning"><?php echo e($stats['waiting_queues']); ?></p>
            <p class="text-sm text-text-secondary mt-1">Menunggu</p>
        </div>
        <div class="bg-surface border border-border rounded-xl p-4 text-center">
            <p class="text-3xl font-bold text-info"><?php echo e($stats['called_queues'] + $stats['serving_queues']); ?></p>
            <p class="text-sm text-text-secondary mt-1">Dipanggil/Dilayani</p>
        </div>
        <div class="bg-surface border border-border rounded-xl p-4 text-center">
            <p class="text-3xl font-bold text-success"><?php echo e($stats['completed_queues']); ?></p>
    ...
    <div class="bg-surface border border-border rounded-xl p-6 mb-8">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $stats['services']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b border-border/50 hover:bg-primary-light/30 transition-colors">
                            <td class="py-3 px-4 font-medium text-text-primary"><?php echo e($service->name); ?></td>
                            <td class="text-center py-3 px-4 text-text-secondary"><?php echo e($service->code); ?></td>
                            ...
                            <td class="text-center py-3 px-4 font-mono text-text-primary"><?php echo e($service->prefix); ?><?php echo e(str_pad($service->current_number, 3, '0', STR_PAD_LEFT)); ?></td>
                            <td class="text-center py-3 px-4">
                                <span class="inline-flex items-center justify-center min-w-[2rem] px-2 py-1 bg-primary-light rounded-full text-primary font-semibold text-xs">
                                    <?php echo e($service->queues_count); ?>
    ...
    <div class="bg-surface border border-border rounded-xl p-6 mb-8">
        ...
        <div class="flex items-center gap-3">
            <a href="<?php echo e(route('queue.download', ['date' => now()->format('Y-m-d')])); ?>"
               class="px-6 py-2.5 bg-primary text-white rounded-lg hover:bg-primary-hover transition-colors font-medium text-sm flex items-center gap-2">
                ...
                Download Hari Ini (<?php echo e(now()->format('d/m/Y')); ?>)
            </a>
        </div>
    </div>
    ...
    <div class="bg-surface border border-border rounded-xl p-6">
        <div class="flex items-center justify-between mb-4">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$showConfirmReset): ?>
                <button
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        class="w-full px-4 py-2.5 bg-background border-2 rounded-lg text-text-primary placeholder-text-secondary/50 focus:outline-none transition-colors
                            <?php if($resetStatus === 'error'): ?> border-danger <?php else: ?> border-border focus:border-primary <?php endif; ?>"
                    >
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($resetStatus === 'error'): ?>
        ...
        <!-- Success Message -->
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($resetStatus === 'success'): ?>
...
<?php /**PATH D:\AI & Plugin Experiment\sistem_antrian_humas\resources\views/livewire/admin-dashboard.blade.php ENDPATH**/ ?>